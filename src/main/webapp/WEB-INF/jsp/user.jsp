			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link" aria-current="page"
						href="ConnectionUtilisateur">Se connecter/S'inscrire</a></li>
				</ul>
			</div>
		</div>
	</nav>
					...
					<div class="row no-gutters">
						...
						<div class="col-sm-9">
							<div class="card-body">
								...
								<p class="card-text">
									<span class="d-block font-weight-bold">Tel : </span> <span><c:out
											value="${utilisateur.getTelephone()}" /></span>
								</p>
								<p class="card-text">
									<span class="d-block font-weight-bold">Email : </span> <span><c:out
											value="${utilisateur.getEmail()}" /></span>
								</p>
							</div>
						</div>
					</div>
