					...
					<div class="row no-gutters">
						...
						<div class="col-sm-9">
									...
									<div class="row">
										<div class="col-12 col-md-6">
											<div class="form-label">
												<label for="nom" class="d-block font-weight-bold">Nom
													:</label> <input class="w-100" type="text" id="nom" name="nom"
													value="<c:out value="${utilisateur.getNom()}" />" required>
											</div>

											<div class="form-label">
												<label for="prenom" class="d-block font-weight-bold">Prénom
													:</label> <input class="w-100" type="text" id="prenom"
													name="prenom"
											...
											<div class="form-label">
												<label for="pseudo" class="d-block font-weight-bold">Pseudo
													:</label> <input class="w-100" type="text" id="pseudo"
													name="pseudo"
													value="<c:out value="${utilisateur.getPseudo()}" />"
													required>
											</div>

											<div class="form-label">
												<label for="rue" class="d-block font-weight-bold">Rue
													:</label> <input class="w-100" type="text" id="rue" name="rue"
													value="<c:out value="${utilisateur.getRue()}" />" required>
											</div>

											<div class="form-label">
												<label for="ville" class="d-block font-weight-bold">Ville
													:</label> <input class="w-100" type="text" id="ville" name="ville"
										...
										<div class="col-12 col-md-6">
											<div class="form-label">
												<label for="codepostal" class="d-block font-weight-bold">Code
													postal :</label> <input class="w-100" type="text" id="codepostal"
													name="codepostal"
											...
											<div class="form-label">
												<label for="tel" class="d-block font-weight-bold">Télephone
													:</label> <input class="w-100" type="text" id="tel" name="tel"
													value="<c:out value="${utilisateur.getTelephone()}" />"
													required>
											</div>

											<div class="form-label">
												<label for="mail" class="d-block font-weight-bold">E-mail
													:</label> <input class="w-100" type="email" id="mail" name="mail"
													value="<c:out value="${utilisateur.getEmail()}" />"
													required>
											</div>

											<div class="form-label">
												<label for="mdp" class="d-block font-weight-bold">Mot
													de passe :</label> <input class="w-100" type="password" id="mdp"
													name="mdp">
							...
							<div class="card-body">
								...
								<p class="card-text">
									<span class="d-block font-weight-bold">Pseudo : </span> <span><c:out
											value="${utilisateur.getPseudo()}" /></span>
								</p>
								<p class="card-text">
									<span class="d-block font-weight-bold">Adresse : </span> <span>
								...
								<p class="card-text">
									<span class="d-block font-weight-bold">Tel : </span> <span>
										<c:out value="${utilisateur.getTelephone()}" />
									</span>
								</p>
								<p class="card-text">
									<span class="d-block font-weight-bold">Email : </span> <span>
