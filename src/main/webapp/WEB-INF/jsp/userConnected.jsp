		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0"  style="margin-left:auto;margin-right:5px!important">
					...
					%>
					<li class="nav-item"><a class="nav-link"
						href="DeconnectionUtilisateur">Se déconnecter</a></li>
				</ul>
			</div>
		</div>
	</nav>
					...
					<div class="row no-gutters">
						...
						<div class="col-sm-9">
									...
									<div class="row">
										<div class="col-12 col-md-6">
											<div class="form-label">
												<label for="nom" class="d-block fw-bold">Nom :</label> <input
													class="w-100 form-control-plaintext" type="text" id="nom"
													name="nom" readonly
													value="<c:out value="${utilisateur.getNom()}" />" required>
											</div>

											<div class="form-label">
												<label for="prenom" class="d-block fw-bold">Prénom :</label>
												<input class="w-100 form-control-plaintext" type="text"
													id="prenom" name="prenom" readonly
													value="<c:out value="${utilisateur.getPrenom()}" />"
													required>
											</div>

											<div class="form-label">
												<label for="pseudo" class="d-block fw-bold">Pseudo :</label>
												<input class="w-100 form-control-plaintext" type="text"
													id="pseudo" name="pseudo" readonly
													value="<c:out value="${utilisateur.getPseudo()}" />"
													required>
											</div>

											<div class="form-label">
												<label for="rue" class="d-block fw-bold">Rue :</label> <input
													class="w-100 form-control-plaintext" type="text" id="rue"
													name="rue" readonly
													value="<c:out value="${utilisateur.getRue()}" />" required>
											</div>

											<div class="form-label">
												<label for="ville" class="d-block fw-bold">Ville :</label> <input
													class="w-100 form-control-plaintext" type="text" id="ville"
													name="ville" readonly
										...
										<div class="col-12 col-md-6">
											<div class="form-label">
												<label for="codepostal" class="d-block fw-bold">Code
													postal :</label> <input class="w-100 form-control-plaintext"
											...
											<div class="form-label">
												<label for="tel" class="d-block fw-bold">Télephone :</label>
												<input class="w-100 form-control-plaintext" type="text"
											...
											<div class="form-label">
												<label for="mail" class="d-block fw-bold">E-mail :</label> <input
													class="w-100 form-control-plaintext" type="email" id="mail"
													name="mail" readonly
											...
											<div class="form-label">
												<label for="mdp" class="d-block fw-bold">Mot de
													passe :</label> <input class="w-100 form-control-plaintext"
							...
							<div class="card-body">
								...
								<p class="card-text">
									<span class="d-block fw-bold">Adresse : </span> <span> <c:out
											value="${utilisateur.getRue()}" /> <c:out
											value="${utilisateur.getVille()}" /> <c:out
											value="${utilisateur.getCodePostal()}" />
									</span>
								</p>
								<p class="card-text">
									<span class="d-block fw-bold">Tel : </span> <span> <c:out
											value="${utilisateur.getTelephone()}" />
									</span>
								</p>
								<p class="card-text">
									<span class="d-block fw-bold">Email : </span> <span> <c:out
